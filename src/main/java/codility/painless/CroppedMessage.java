...
public class CroppedMessage {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(croppedMessage.solution("123456789123456789The quick brown fox jumps over the lazy dog", 39));
    System.out.println(croppedMessage.solution("123456789123456789The quick brown fox jumps over the lazy dog", 21));
